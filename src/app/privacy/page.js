export const metadata = {
    title: "API Exchange - Privacy Policy",
    description: "API Exchange Privacy Policy. Learn how we handle your data.",
};
                    ...
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div className="px-4 py-5 sm:p-6">
                            <div className="prose max-w-none">
                                ...
                                <p>Welcome to API Exchange ("we," "our," or "us"). We respect your privacy and are
                                    committed to protecting your personal data. This privacy policy explains how we
                                    collect, use, disclose, and safeguard your information when you use our API Exchange
                                    platform and related services.</p>
                                <p>Please read this privacy policy carefully. If you do not agree with the terms of this
                                    privacy policy, please do not access our platform.</p>

                                <h2 className="text-xl font-semibold mt-8 mb-4">2. Information We Collect</h2>
                                <h3 className="text-lg font-medium mt-6 mb-3">2.1 Personal Data</h3>
                                <p>We may collect personal information that you voluntarily provide when using our
                                    platform, including but not limited to:</p>
                                <ul className="list-disc pl-6 mb-4">
                                    <li>Contact information (such as name, email address, phone number, and company
                                        name)
                                    </li>
                                ...
                                <ul className="list-disc pl-6 mb-4">
                                    ...
                                    <li>Log data (such as IP address, browser type, pages visited, time and date of
                                        visit)
                                    </li>
                                ...
                                <ul className="list-disc pl-6 mb-4">
                                    ...
                                    <li>Send administrative information, such as updates, security alerts, and support
                                        messages
                                    </li>
                                ...
                                <ul className="list-disc pl-6 mb-4">
                                    <li>Service providers who perform services on our behalf (such as hosting, payment
                                        processing, and analytics)
                                    </li>
                                    <li>Business partners with whom we offer co-branded services or joint marketing
                                        activities (with your consent where required)
                                    </li>
                                    <li>Third-party integrations you choose to enable through our platform</li>
                                    <li>Legal authorities when required by law, to protect our rights, or to protect the
                                        rights of our users
                                    </li>
                                </ul>
                                ...
                                <p>We implement appropriate technical and organizational measures to protect your
                                    ...
                                    destruction, or damage. However, no method of transmission over the Internet or
                                ...
                                <p>To exercise any of these rights, please contact us using the information provided in
                                    the "Contact Us" section below.</p>

                                <h2 className="text-xl font-semibold mt-8 mb-4">8. Cookies and Similar Technologies</h2>
                                <p>We use cookies and similar tracking technologies to collect information about your
                                    browsing activities and to remember your preferences. You can instruct your browser
                                    to refuse all cookies or to indicate when a cookie is being sent. However, if you do
                                    not accept cookies, you may not be able to use some portions of our platform.</p>

                                <h2 className="text-xl font-semibold mt-8 mb-4">9. Children's Privacy</h2>
                                <p>Our platform is not intended for children under the age of 16. We do not knowingly
                                ...
                                <p>Your information may be transferred to and processed in countries other than the
                                    country in which you reside. These countries may have data protection laws that are
                                    different from those in your country. We have implemented appropriate safeguards to
                                    protect your personal data when transferred internationally.</p>
