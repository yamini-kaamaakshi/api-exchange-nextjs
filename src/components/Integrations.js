...
const integrationsData = [
    ...
    { name: "HubSpot", logo: "https://victorycto.com/wp-content/uploads/2023/04/2560px-HubSpot_Logo.png" }
];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-4">
                    {integrations.map((integration, index) => (
                        <div key={index} className="flex flex-col justify-center items-center p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 h-full">
                            <div className="flex items-center justify-center h-full">
                                <Image className="h-12 object-contain" width={250} height={50} src={integration.logo} alt={integration.name} />
                            </div>
